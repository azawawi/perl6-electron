...
app.on('ready', function() {
  ...
  server.addMethod("Screen-get_all_displays", function(param, callback) {
    var result =  {"result": Screen.getAllDisplays()};
    callback(0, result);
  });

  server.addMethod("Screen-get_display_nearest_point", function(param, callback) {
    param      = param || {};
  ...
  server.addMethod("Screen-get_display_matching", function(param, callback) {
    param      = param || {};
    var rect  = param.rect   || {};
